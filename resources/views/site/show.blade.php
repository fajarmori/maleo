                    ...
                    <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                        <table id="listSite" class="min-w-full divide-y divide-gray-300">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <tr>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">Code</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">:</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">{{ $site->code }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">Owner</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">:</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm">{{ $site->owner }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">Description</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">:</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">{{ $site->description }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">Address</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">:</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">{{ $site->district }}, {{ $site->regency }}, {{ $site->province }}</td>
                                </tr>
                                <tr>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">Email</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">:</td>
                                    <td class="whitespace-normal text-wrap px-3 py-2 text-sm text-gray-500">{{ $site->user->email??'-' }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
