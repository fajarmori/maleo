...
$.extend( true, DataTable.ext.classes, {
	...
	length: {
		select: "border pl-3 pr-6 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-gray-800 dark:border-gray-600 dark:focus:border-blue-500"
	},
	processing: {
	...
	paging: {
		...
		button: 'relative inline-flex justify-center items-center space-x-2 border px-3 py-1 -mr-px leading-6 hover:z-10 focus:z-10 active:z-10 border-gray-200 active:border-gray-200 active:shadow-none dark:border-gray-700 dark:active:border-gray-700',
		first: 'rounded-l-lg',
		last: 'rounded-r-lg',
...
DataTable.ext.renderer.pagingContainer.tailwindcss = function (settings, buttonEls) {
	...
	return $('<ul/>').addClass('pagination flex sm:justify-center px-3 pt-2 pb-3').append(buttonEls);
};
